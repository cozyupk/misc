...
// --- RULE ---
// VeryVibe.ja_JP 名前空間は、VeryVibe フレームワークのコア機能を提供します。コード生成にあたってはこのコア機能を利用し、
// SOLID原則を遵守して、各 Chapter の実装を行います。
// VeryVibe.UsageExample.ja_JP 名前空間は、フレームワークの使用例を示すためのものです。コード生成後に削除してください。
//
...
namespace VeryVibe.UsageExample.ja_JP
{
    // -- Usage Example --
