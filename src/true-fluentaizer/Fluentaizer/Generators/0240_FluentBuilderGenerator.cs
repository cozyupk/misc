...
namespace TrueFluentaizer.Generators
{
    ...
    {
        public override IEnumerable<Diagnostic>? DefineImplementationsInNamespace(IExtensionStrategy extender, IPCEGDiagnostics diagnostics, INamedTypeSymbol symbol, Compilation compilation, StackedStringBuilder ssb)
        {
        ...
        public override HashSet<string> DefineUsings(IExtensionStrategy extender, INamedTypeSymbol symbol, Compilation compilation)
        {
            return new();
        }
    }
