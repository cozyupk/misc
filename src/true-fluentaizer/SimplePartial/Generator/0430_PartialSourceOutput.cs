...
namespace PartialClassExtGen.Generator
{
    ...
    /// cref="IExtensionStrategy"/>  to generate the implementations and an <see cref="IPCEGDiagnostics"/>
    ...
    public sealed class SourceOutput<TPartialClassExtender, TDiagnostics, TTargetClassMeta>
