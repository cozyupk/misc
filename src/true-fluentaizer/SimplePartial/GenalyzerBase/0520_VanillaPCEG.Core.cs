...
namespace PartialClassExtGen.GenalyzerBase
{
    ...
    public abstract partial class VanillaPCEG<TAttribute, TPartialClassExtender, TDiagnostics, TTargetClassMeta>
        : ExtendedAnalyzerBase<TPartialClassExtender, TDiagnostics>, IIncrementalGenerator, IExtensionStrategy
        ...
        where TTargetClassMeta : ITargetClassMeta
    {
        ...
        /// By default, it uses itself as an <see cref="IExtensionStrategy"/> to initialize these components.</remarks>
        ...
        /// <summary>
        /// Creates and returns an instance of an object that implements the <see cref="IExtensionStrategy"/>
        /// interface.
        /// </summary>
        /// <remarks>This method is intended to be overridden in derived classes to provide a custom
        /// implementation of  <see cref="IExtensionStrategy"/>. By default, it returns the current
        /// instance.</remarks>
        /// <returns>An instance of an object that implements the <see cref="IExtensionStrategy"/> interface.</returns>
        ...
        /// <param name="extender">The <see cref="IExtensionStrategy"/> instance used to provide extension-related data for diagnostics.</param>
