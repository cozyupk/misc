...
namespace Boostable.Syntax.Core.BaseImpl.Utils
{
    ...
    /// </summary>
    /// <remarks>The <see cref="DefaultStackedStringBuilder"/> class allows for efficient and structured string
    ...
    public class DefaultStackedStringBuilder : IStackedStringBuilder
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates and returns a new child <see cref="DefaultStackedStringBuilder"/> instance.
        /// </summary>
        /// <remarks>The child instance inherits the state of the current <see
        /// cref="DefaultStackedStringBuilder"/>  and can be used to build upon the existing content without modifying the
        /// parent instance.</remarks>
        /// <returns>A new <see cref="DefaultStackedStringBuilder"/> instance that is initialized with the current instance as its
        /// parent.</returns>
        public virtual IStackedStringBuilder SpawnChild()
        {
            return new DefaultStackedStringBuilder(this);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultStackedStringBuilder"/> class,
        ...
        /// </exception>
        public DefaultStackedStringBuilder(StringBuilder parentStringBuilder, HashSet<IStackedStringBuilder>? registry = null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultStackedStringBuilder"/> class with a specified parent and an
        /// optional registry for tracking instances.
        /// </summary>
        /// <param name="parentStackedStringBuilder">The parent <see cref="DefaultStackedStringBuilder"/> instance. This parameter cannot be <see langword="null"/>.</param>
        ...
        public DefaultStackedStringBuilder(DefaultStackedStringBuilder parentStackedStringBuilder)
        {
        ...
        public void MergeFrom(IEnumerable<IStringBuilderEntry> entries, string indentUnitString)
        {
            lock (BufferLock)
            {
                ...
                if (!needIndent)
                {
                    AppendLine(); // Ensure the last entry ends with a newline if not terminated
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            using (var dumper = new DefaultStackedStringBuilder(sb))
            {
        ...
        /// <summary>
        /// Gets the parent <see cref="StringBuilder"/> or <see cref="DefaultStackedStringBuilder"/> that this instance is associated with.
        /// </summary>
        private StringBuilder? ParentStringBuilder { get; }

        /// <summary>
        /// Gets the parent <see cref="DefaultStackedStringBuilder"/> instance, if one exists.
        /// </summary>
        private DefaultStackedStringBuilder? ParentStackedStringBuilder { get; }
    }
}
